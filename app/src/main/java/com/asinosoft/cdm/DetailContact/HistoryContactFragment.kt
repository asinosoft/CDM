...
class HistoryContactFragment : Fragment() {
    ...
    companion object {
        fun newInstance() = HistoryContactFragment()
    }

    private lateinit var viewModel: HistoryContactViewModel
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this).get(HistoryContactViewModel::class.java)
    ...
    private fun getContactInfo(number: String): ArrayList<ContactItem>{
        ...
        val cursor1: Cursor = context!!.contentResolver.query(ContactsContract.CommonDataKinds.Email.CONTENT_URI,
            arrayOf(ContactsContract.CommonDataKinds.Email.TYPE, ContactsContract.CommonDataKinds.Email.ADDRESS), selection1, selectionArg1, null)!!
